...
public class FlutterAppauthPlugin implements FlutterPlugin, MethodCallHandler, PluginRegistry.ActivityResultListener, ActivityAware {
    ...
    private AuthorizationTokenRequestParameters processAuthorizationTokenRequestArguments(Map<String, Object> arguments) {
        ...
        final boolean plainCodeVerifierChallengeMethod = (boolean) arguments.get("plainCodeVerifierChallengeMethod");
        return new AuthorizationTokenRequestParameters(clientId, issuer, discoveryUrl, scopes, redirectUrl, serviceConfigurationParameters, additionalParameters, loginHint, promptValues, plainCodeVerifierChallengeMethod);
    }
    ...
    private void performAuthorization(AuthorizationServiceConfiguration serviceConfiguration, String clientId, String redirectUrl, ArrayList<String> scopes, String loginHint, Map<String, String> additionalParameters, boolean exchangeCode, ArrayList<String> promptValues, boolean plainCodeVerifierChallengeMethod) {
        ...
        if (plainCodeVerifierChallengeMethod) {
          String codeVerifier = CodeVerifierUtil.generateRandomCodeVerifier();
          authRequestBuilder.setCodeVerifier(codeVerifier, codeVerifier, "plain");
        }
    ...
    private class AuthorizationTokenRequestParameters extends TokenRequestParameters {
        ...
        final boolean plainCodeVerifierChallengeMethod;

        private AuthorizationTokenRequestParameters(String clientId, String issuer, String discoveryUrl, ArrayList<String> scopes, String redirectUrl, Map<String, String> serviceConfigurationParameters, Map<String, String> additionalParameters, String loginHint, ArrayList<String> promptValues, boolean plainCodeVerifierChallengeMethod) {
