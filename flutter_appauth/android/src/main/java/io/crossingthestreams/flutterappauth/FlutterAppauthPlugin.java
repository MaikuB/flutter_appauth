    ...
    switch (call.method) {
      ...
      case AUTHORIZE_METHOD:
        try {
          ...
          finishWithError(
              AUTHORIZE_ERROR_CODE, ex.getLocalizedMessage(), getCauseFromException(ex));
        }
        break;
      case TOKEN_METHOD:
        try {
      ...
      case END_SESSION_METHOD:
        try {
          ...
          finishWithError(
              END_SESSION_ERROR_CODE, ex.getLocalizedMessage(), getCauseFromException(ex));
        }
        break;
      default:
    ...
    if (additionalParameters != null && !additionalParameters.isEmpty()) {
      ...
      if (additionalParameters.containsKey("claims")) {
        try {
          ...
          finishWithError(
              INVALID_CLAIMS_ERROR_CODE, ex.getLocalizedMessage(), getCauseFromException(ex));
          return;
        }
      }
  ...
  private void processAuthorizationData(
    ...
    if (authException == null) {
      ...
      finishWithError(
          ...
          getCauseFromException(authException));
    }
  }
