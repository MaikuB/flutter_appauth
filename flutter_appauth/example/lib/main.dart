...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _signInWithNoCodeExchange() async {
    try {
      ...
      // the code_challenge is generated by from the code verifier and only the code verifier is included in the result
      // this is because to get the token in _exchangeCode we need only the codeVerifier and the authorizationCode
