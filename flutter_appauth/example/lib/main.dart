  ...
  Future<void> _signInWithNoCodeExchange() async {
    try {
      ...
      /* 
         ...
         This because to get the token in the method _exchangeCode (see above) we need only the code verifier and the authorization code according to the spec https://www.rfc-editor.org/rfc/rfc7636 page 9 section 4.5.
      */
