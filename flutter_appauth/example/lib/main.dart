...
class _MyAppState extends State<MyApp> {
  ...
  Future<void> _signInWithNoCodeExchange() async {
    try {
      ...
      // the code_challenge is generated from the code verifier and only the code verifier is included in the result
      // this is because to get the token in the method _exchangeCode (see above) we need only the codeVerifier and the authorizationCode
      // according to the spec https://www.rfc-editor.org/rfc/rfc7636 page 9 section 4.5
