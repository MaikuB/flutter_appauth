...
- (id<OIDExternalUserAgentSession>)
  ...
  UIViewController *rootViewController = [self rootViewController];
  id<OIDExternalUserAgent> externalUserAgent = [self
      userAgentWithViewController:rootViewController
              useEphemeralSession:requestParameters.preferEphemeralSession];
