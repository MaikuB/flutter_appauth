...
/*
 * Come from https://github.com/openid/AppAuth-Android/blob/master/app/java/net/openid/appauthdemo/ConnectionBuilderForTesting.java
...
public class InsecureConnectionBuilder implements ConnectionBuilder {
    ...
    public HttpURLConnection openConnection(@NonNull Uri uri) throws IOException {
        ...
        Preconditions.checkArgument(HTTP.equals(uri.getScheme()) || HTTPS.equals(uri.getScheme()),
                "scheme or uri must be http or https, actually:" + uri.getScheme());
